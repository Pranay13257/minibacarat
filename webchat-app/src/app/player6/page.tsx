  ...
  const handleMessage = (data: any) => {
    switch(data.action) {
      case 'game_state':
        ...
        setIsActive(newGameState.activePlayers.includes('player6'));
        break;
    }
  };

  const isVipMode = gameState.game_mode === 'vip';
  const isRevealer = isVipMode && gameState.vip_revealer === 'player6';
      ...
      <div className="bg-gray-900 text-white p-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-4">
            <h1 className="text-3xl font-bold mb-2">🎰 Mini Baccarat - Player 6</h1>
                ...
                isRevealer ? (
                  <div className="mb-8 text-center">
                    <button
                      ...
                      onClick={() => socket?.send(JSON.stringify({ action: 'vip_reveal', player_id: 'player6' }))}
                      disabled={!connected}
                    >
                      👁️ Reveal Cards
                    </button>
